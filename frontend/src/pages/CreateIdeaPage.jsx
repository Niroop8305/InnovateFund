...
const CreateIdeaPage = () => {
  ...
  const createIdeaMutation = useMutation(
    (data) => api.ideas.createIdea(data),
    {
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            Share your groundbreaking idea with our community of investors and collaborators. 
            Get AI-powered insights and connect with the right people to bring your vision to life.
          </p>
        </div>
            ...
            <div>
              ...
              >
                ...
                <p className="text-xs text-gray-500">
                  Support for images, videos, PDFs, and documents (max 5 files, 10MB each)
                </p>
              </div>
