...
const ChatPage = () => {
  const { user } = useAuth();
  const { socket, joinChat, leaveChat, startTyping, stopTyping, isUserOnline } =
    useSocket();
  ...
  return (
    <div className="h-screen overflow-hidden">
      <div className="h-full bg-gray-50 dark:bg-slate-950 flex pt-16">
        {/* Sidebar */}
          ...
          <div className="flex-1 overflow-y-auto">
            {chatsLoading ? (
                    ...
                    <button
                      ...
                      className={`w-full p-4 text-left transition-colors focus:outline-none ${
                        selectedChat?._id === chat._id
                          ? "bg-primary-50 dark:bg-primary-900/20 border-r-2 border-primary-600 dark:border-primary-500"
                        ...
                        <div className="relative">
                          <img
                            src={
                              ...
                              `https://ui-avatars.com/api/?name=${otherParticipant?.name}&background=667eea&color=fff`
                            }
              ...
              <div className="flex flex-col items-center justify-center py-12">
                <MessageSquare className="w-12 h-12 text-gray-400 dark:text-slate-600 mb-3" />
                ...
                {messagesLoading ? (
                  ...
                  <>
                    {messages.map((message, index) => {
                      const isOwn =
                        (message.sender?._id || message.senderId) === user._id;
                      const showDate =
                        index === 0 ||
                      ...
                      <div className="flex items-center">
                        <img
                          src={
                            ...
                            `https://ui-avatars.com/api/?name=${searchUser.name}&background=667eea&color=fff`
                          }
                          alt={searchUser.name}
